...
use pallo\library\orm\query\ModelJoin;
...
class QueryParser {
     ...
     * @param pallo\library\orm\query\ModelQuery $modelQuery
     * @return null
     */
...
//        $this->addGroupBy($groupBy);
     ...
     * @param pallo\library\database\manipulation\expression\TableExpression $relationTable
     ...
     * @param pallo\library\database\manipulation\expression\TableExpression $table
     * @param pallo\library\database\manipulation\expression\TableExpression $relationTable
     * @param pallo\library\database\manipulation\expression\TableExpression $linkTable
     * @param string $fieldName
     * @return null
     */
     ...
     * @param pallo\library\database\manipulation\expression\FieldExpression $fieldExpression
     * @return null
     */
     ...
     * @param pallo\library\database\manipulation\expression\Expression $expression Expression to process
     * @param boolean $inCondition Flag to see whether the provided expression is used in a condition or not
     * @return pallo\library\database\manipulation\expression\Expression Processed expression
     */
     ...
     * @param pallo\library\database\manipulation\expression\FieldExpression $expression Field expression to process
     * @param boolean $inCondition Flag to see whether the provided expression is used in a condition or not
     * @return pallo\library\database\manipulation\expression\FieldExpression Processed expression
     */
     ...
     * @param TableExpression $table Table of the field
     * @param boolean $inCondition Flag to see whether the provided expression is used in a condition or not
     * @return pallo\library\database\manipulation\expression\FieldExpression
     */
...
//        }
     ...
     * @param string $name Name of the field
     * @param pallo\library\database\manipulation\expression\TableExpression $table Table expression for the field
     * @param boolean $inCondition Flag to see whether the provided expression is used in a condition or not
     * @return pallo\library\database\manipulation\expression\FieldExpression
     */
     ...
     * @param pallo\library\database\manipulation\expression\FunctionExpression $expression Function expression to process
     * @param boolean $inCondition Flag to see whether this expression is used in a condition or else where
     * @return pallo\library\database\manipulation\expression\FunctionExpression Processed function expression
     */
     ...
     * @param pallo\library\database\manipulation\condition\Condition $condition Condition to process
     * @return pallo\library\database\manipulation\condition\Condition Processed condition
     */
     ...
     * @param pallo\library\database\manipulation\condition\NestedCondition $condition Condition to process
     * @return pallo\library\database\manipulation\condition\NestedCondition $condition Processed condition
     */
     ...
     * @param pallo\library\database\manipulation\condition\SimpleCondition $condition Condition to process
     * @return pallo\library\database\manipulation\condition\SimpleCondition $condition Processed condition
     */
     ...
     * @param pallo\library\orm\query\ModelExpression $condition
     */
     ...
     * @param pallo\library\orm\query\ModelJoin $join
     * @return pallo\library\database\manipulation\expression\JoinExpression
     */
     ...
     * @return pallo\library\database\manipulation\expression\OrderExpression
     */
     ...
     * @return pallo\library\database\manipulation\expression\TableExpression
     */
     ...
     * @param pallo\library\orm\definition\field\RelationField $field
     * @return null
     */
     ...
     * @param pallo\library\database\manipulation\expression\JoinExpression $join
     * @return null
     */
     ...
     * @param pallo\library\database\manipulation\expression\TableExpression $table Table expression of the table with the shared data
     * @param pallo\library\database\manipulation\expression\TableExpression $localizedTable Table expression of the table with the localized data
     * @return pallo\library\database\manipulation\condition\NestedCondition Condition to localize the provided table
     */
