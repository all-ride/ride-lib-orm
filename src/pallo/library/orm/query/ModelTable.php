...
class ModelTable {
     ...
     * @param pallo\library\orm\model\ModelMeta $meta Meta of the model of the query, to check if the alias is not a field name
     * @return null
     */
     ...
     * @return null
     * @throws pallo\library\orm\exception\OrmException when the name is invalid
     */
