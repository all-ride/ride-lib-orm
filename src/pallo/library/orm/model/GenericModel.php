...
use pallo\library\orm\model\data\DataFactory;
use pallo\library\orm\model\data\DataValidator;
...
//    }
     ...
     * @param integer $id Primary key of the data which is being saved
     * @param string $fieldName Name of the has many field
     * @param pallo\library\orm\definition\field\ModelField $foreignKey Definition of the foreign key field in the link model
     * @return null
     */
     ...
     * @param pallo\library\orm\definition\field\RelationField $field Definition of the relation field
     ...
     * @param string $fieldName Name of the has many field
     * @param pallo\library\orm\definition\field\HasManyField $field Definition of the has many field
     * @param mixed $data Data obiect
     * @return null
     */
     ...
     * @param pallo\library\orm\definition\ModelTable $modelTable Table definition of the model of the has many relation
     ...
     * @return null
     * @throws pallo\library\validation\exception\ValidationException when the data is referenced in another model
     */
