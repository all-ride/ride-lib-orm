...
namespace pallo\library\orm\model;
...
use pallo\library\orm\model\behaviour\Behaviour;
use pallo\library\orm\model\data\validator\GenericDataValidator;
use pallo\library\orm\model\meta\ModelMeta;
use pallo\library\orm\query\parser\ResultParser;
use pallo\library\orm\query\CachedModelQuery;
...
abstract class AbstractModel implements Model, Serializable {
     ...
     * @var pallo\library\orm\query\parser\ResultParser
     */
     ...
     * @param pallo\library\orm\model\behaviour\Behaviour $behaviour
     * @return null
     */
     ...
     * @return pallo\library\orm\query\parser\ResultParser
     */
     ...
     * @return null
     * @throws pallo\library\orm\exception\OrmException when the validation factory is not set
     * @throws pallo\library\validation\exception\ValidationException when one of the fields is not valid
     */
     ...
     * @return null
     * @throws pallo\library\validation\exception\ValidationException when the field is not valid
     */
     ...
     * @return pallo\library\model\data\validator\DataValidator
     */
     ...
     * @throws pallo\library\orm\exception\ModelException when no primary key could be retrieved from the data
     */
     ...
     * @throws pallo\library\orm\exception\OrmException when the provided locale is invalid
     */
     ...
     * @return pallo\library\orm\model\LocalizedModel
     */
     ...
     * @param string $fieldName Name of the relation field
     * @return pallo\library\definition\ModelTable
     */
     ...
     * @return Model
     * @throws pallo\library\orm\exception\OrmException when the provided model could not be retrieved
     */
     ...
     * @param pallo\library\database\manipulation\statement\Statement
     * @return pallo\library\database\DatabaseResult
     */
