...
class LocalizedModel extends GenericModel {
     ...
     * @param integer $id Primary key of the unlocalized data
     * @return null
     * @throws pallo\ZiboException when the provided id is empty or invalid
     */
     ...
     * @throws pallo\ZiboException when the id is empty or invalid
     * @throws pallo\ZiboException when the locale is empty or invalid
     */
