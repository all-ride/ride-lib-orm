...
class ModelRegister {
     ...
     * false otherwise
     * @throws pallo\library\orm\exception\OrmException when the provided model
     * name is empty
     */
     ...
     * @param string $modelName Name of the model
     * @return pallo\library\orm\model\Model The requested model
     * @throws pallo\library\orm\exception\OrmException when the requested model
     * is not registered
     */
    ...
    /**
     * Registers a model
     * @param pallo\library\orm\model\Model $model Model to register
     ...
     * @return pallo\library\orm\model\Model The registered model
     */
     ...
     * @param pallo\library\orm\definition\field\HasField $field1
     * @param pallo\library\orm\definition\field\HasField $field2
     * @return pallo\library\orm\model\Model The registered model
     */
     ...
     * @param pallo\library\orm\definition\field\HasManyField $field1
     * @param pallo\library\orm\definition\field\HasManyField $field2
     * @param pallo\library\orm\model\meta\ModelMeta $modelMeta Meta of the
     * model of the field
     * @param string $fieldName Field for the link model
     * @return string Name of the link model
     * @throws pallo\library\orm\exception\ModelException when field1 and
     ...
     * references models
     * @param pallo\library\orm\model\Model $model Model of the link field
     * @param pallo\library\orm\model\Model $relationModel Model referenced by
     * the link field
     * @param pallo\library\orm\model\Model $linkModel Model used to link the
