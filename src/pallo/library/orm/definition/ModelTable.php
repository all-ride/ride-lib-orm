...
namespace pallo\library\orm\definition;
...
use pallo\library\orm\model\data\format\DataFormat as Format;
...
class ModelTable {
     ...
     * @param string $name
     * @return null
     * @throws pallo\ZiboException when the name is empty or invalid
     */
     ...
     * @return null
     * @throws pallo\library\orm\exception\ModelException when the name of the field is already set in this model
     * @throws pallo\library\orm\exception\ModelException when the field has the same link as another field in this model
     */
     ...
     * @return null
     * @throws pallo\ZiboException when the provided name is empty or invalid
     * @throws pallo\library\orm\exception\ModelException when the field is not in this model
     */
     ...
     * @param pallo\library\database\definition\Index $index index to add to the table
     * @return null
     * @throws pallo\library\orm\exception\ModelException when a field of the index is not in this table
     * @throws pallo\library\orm\exception\ModelException when a field of the index is not a property or a belongs to field
     */
     ...
     * @throws pallo\library\orm\exception\ModelException when a field of the index is not in this table
     * @throws pallo\library\orm\exception\ModelException when a field of the index is not a property or a belongs to field
     * @throws pallo\library\orm\exception\ModelException when the index contains out of localized and unlocalized fields
     */
     ...
     * @return pallo\library\database\definition\Index index definition of the index
     * @throws pallo\ZiboException when no valid string provided as name
     * @throws pallo\library\orm\exception\ModelException when the name is empty or the index does not exist
     */
     ...
     * @throws pallo\ZiboException when no valid string provided as name
     * @throws pallo\library\orm\exception\ModelException when the name is empty
     * @throws pallo\ZiboException when the name is invalid
     */
     ...
     * @return null
     * @throws pallo\ZiboException when the provided name is empty or invalid
     * @throws pallo\library\orm\exception\ModelException when the index is not in this model
     */
     ...
     * not set
     * @throws pallo\library\orm\exception\ModelException when there is no data
     ...
     * @throws pallo\ZiboException when the provided name is empty or not a string
     */
     ...
     * @param string $name Name of the data format
     * @return null
     * @throws pallo\library\orm\exception\ModelException
     */
